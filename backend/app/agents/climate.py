...
from app.schemas import ClimateOutput, ScenarioContext, HistorianOutput, AgentOutputSummary, UnifiedTimelineEvent
...
) -> tuple[ClimateOutput, list[str], list[str]]:
